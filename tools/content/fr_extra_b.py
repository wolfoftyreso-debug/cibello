...
GUIDES2 = {
    ...
    "weekend-dinners": dict(
        ...
        desc="Idées de repas pour le week-end : un vendredi sans stress, un samedi simple mais soigné et un dimanche mijoté qui remplit les boîtes-repas.",
    ...
    "budget-food": dict(
        ...
        desc="Manger pas cher sans manger triste : un menu de la semaine économique, des courses limitées à ce qui manque et des produits utilisés jusqu’au bout.",
    ...
    "eu-food-waste-stats": dict(
        ...
        desc="Combien de nourriture est gaspillée dans l’UE ? Chiffres Eurostat 2023 : 58,2 millions de tonnes, 130 kg par habitant, plus de la moitié dans les foyers.",
    ...
    "ai-meal-planner": dict(
        ...
        desc="Un planificateur de repas IA qui scanne votre frigo, apprend les goûts du foyer et planifie la semaine avec ce que vous avez. Et où l’IA peut se tromper.",
    ...
    "pantry-app": dict(
        ...
        desc="Une application garde-manger qui remplit l’inventaire depuis photos, tickets et codes-barres, suit les dates et propose des recettes avec ce que vous avez.",
        eyebrow="Inventaire",
    ...
    "app-comparison": dict(
        ...
        desc="Comparatif des applis de planification de repas : Cibello, Mealime, Samsung Food, Plan to Eat, Paprika, SuperCook. Inventaire, planning, listes, prix.",
        eyebrow="Comparatif",
    ...
    "recipe-app-comparison": dict(
        ...
        desc="Quelle application de recettes choisir ? Cibello face à Paprika, Samsung Food, Yummly, SideChef et SuperCook : inventaire, menu de la semaine, liste.",
        eyebrow="Comparatif",
