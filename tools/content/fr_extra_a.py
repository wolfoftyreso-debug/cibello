...
GUIDES2 = {
    ...
    "everyday-food": dict(
        ...
        desc="Des repas du quotidien qui tiennent toute la semaine : partir de ce qu’il y a dans le frigo, varier sans effort et cuisiner dans le temps dont vous disposez.",
    ...
    "quick-dinner": dict(
        ...
        desc="Un dîner rapide avec ce qu’il y a déjà chez vous : tableau de plats prêts en 15 à 30 minutes, méthode pour obtenir une idée en une minute et conseils pour les enfants.",
    ...
    "family-dinner": dict(
        ...
        desc="Des idées de repas en famille que les enfants acceptent, un menu de la semaine qui évite les négociations à 18 h, et une liste de courses partagée pour tout le foyer.",
